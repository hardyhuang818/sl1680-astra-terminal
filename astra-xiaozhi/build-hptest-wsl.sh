#!/bin/bash
# 浜ゅ弶缂栬瘧 dl_hptest (DP AUX 妫€娴嬭瘖鏂伐鍏? 鈥斺€?涓?build-dlface-wsl.sh 鍚屼竴濂楀伐鍏烽摼
set -e
...
SRC="$BASE/meta-dlsdk/recipes-graphics/dl-face/files/dl_hptest.c"
DLSDK_DIR="$BASE/meta-dlsdk/recipes-graphics/dlsdk/files"
OUT="$BASE/astra-xiaozhi/dl_hptest"
